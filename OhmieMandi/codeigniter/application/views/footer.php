...
<footer>
<?php  
echo "<a href='index.php?action=login'>User Login</a>
	<a href='home'>Home</a><br /><p>2013, A Site of Ice &amp; Fire</p>";
?>
</footer>
</html>-->
	...
	<script src="<?php echo base_url(); ?>public/js/vendor/jquery.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>public/js/foundation.min.js"></script> 
	<script>
//		files that use this footer will use Foundation framework 
		$(document).foundation();
	</script>
